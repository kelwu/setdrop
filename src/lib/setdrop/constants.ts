...
export const SAMPLE_TRACKS: SampleTrack[] = [
  { pos:1, artist:'Burna Boy', title:'Last Last', bpm:107, key:'4A', energy:3,
    ...
    stores:{ beatport:'green', bpmSupreme:'green', traxsource:'yellow', djcity:'green', spotify:'green' }},
  { pos:2, artist:'Wizkid', title:'Essence (feat. Tems)', bpm:112, key:'4B', energy:4,
    ...
    stores:{ beatport:'green', bpmSupreme:'green', traxsource:'green', djcity:'green', spotify:'green' }},
  { pos:3, artist:'Drake', title:'Rich Flex', bpm:138, key:'11B', energy:6,
    ...
    stores:{ beatport:'yellow', bpmSupreme:'green', traxsource:'red', djcity:'green', spotify:'green' }},
  { pos:4, artist:'Adekunle Gold', title:'Okay (feat. Wale)', bpm:120, key:'9A', energy:6,
    ...
    stores:{ beatport:'green', bpmSupreme:'yellow', traxsource:'green', djcity:'green', spotify:'green' }},
  { pos:5, artist:'4B & Chris Lorenzo', title:'Baddadan', bpm:128, key:'8B', energy:9,
    ...
    stores:{ beatport:'green', bpmSupreme:'yellow', traxsource:'green', djcity:'yellow', spotify:'yellow' }},
  { pos:6, artist:'Tems', title:'Free Mind', bpm:124, key:'6A', energy:7,
    ...
    stores:{ beatport:'yellow', bpmSupreme:'green', traxsource:'yellow', djcity:'green', spotify:'green' }},
  ...
  { pos:8, artist:'Davido', title:'Fall', bpm:103, key:'3A', energy:4,
    ...
    stores:{ beatport:'red', bpmSupreme:'yellow', traxsource:'green', djcity:'green', spotify:'green' }},
];

export const LIBRARY_TRACKS: SampleTrack[] = [
  ...SAMPLE_TRACKS,
  { pos:9, artist:'Afrobeats All Stars', title:'Feeling', bpm:112, key:'4B', energy:5, wishlist:false, wordplay:null, why:'', transition:'', stores:{beatport:'green',bpmSupreme:'green',traxsource:'green',djcity:'green',spotify:'green'} },
  { pos:10, artist:'Kizz Daniel', title:'Cough (Odo)', bpm:108, key:'2A', energy:4, wishlist:false, wordplay:null, why:'', transition:'', stores:{beatport:'green',bpmSupreme:'yellow',traxsource:'green',djcity:'green',spotify:'green'} },
  { pos:11, artist:'Ayra Starr', title:'Rush', bpm:115, key:'7B', energy:5, wishlist:true, wordplay:null, why:'', transition:'', stores:{beatport:'yellow',bpmSupreme:'green',traxsource:'yellow',djcity:'green',spotify:'green'} },
  { pos:12, artist:'Rema', title:'Calm Down', bpm:106, key:'1A', energy:4, wishlist:false, wordplay:null, why:'', transition:'', stores:{beatport:'green',bpmSupreme:'green',traxsource:'green',djcity:'green',spotify:'green'} },
  { pos:13, artist:'Omah Lay', title:'Soso', bpm:118, key:'8A', energy:5, wishlist:false, wordplay:null, why:'', transition:'', stores:{beatport:'yellow',bpmSupreme:'green',traxsource:'green',djcity:'green',spotify:'green'} },
  { pos:14, artist:'Fireboy DML', title:'Peru', bpm:126, key:'10B', energy:6, wishlist:true, wordplay:null, why:'', transition:'', stores:{beatport:'green',bpmSupreme:'yellow',traxsource:'red',djcity:'green',spotify:'green'} },
  { pos:15, artist:'Asake', title:'Organise', bpm:133, key:'6B', energy:7, wishlist:false, wordplay:null, why:'', transition:'', stores:{beatport:'green',bpmSupreme:'green',traxsource:'yellow',djcity:'green',spotify:'green'} },
];
