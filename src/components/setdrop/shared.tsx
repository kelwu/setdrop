        ...
        <div style={{ display:'flex', alignItems:'center', gap:12 }}>
          ...
          <button
            ...
            style={{
              ...
              background: pathname === '/id' ? SD.accentDim : 'transparent',
              border:`1px solid ${pathname === '/id' ? SD.accent+'66' : SD.border}`,
              display:'flex', alignItems:'center', justifyContent:'center',
              transition:'border-color .15s, background .15s', padding:0,
            }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = SD.accent; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = pathname === '/id' ? SD.accent+'66' : SD.border; }}
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
              stroke={pathname === '/id' ? SD.accent : SD.textSec}
